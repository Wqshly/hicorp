...
public class CustomerController {
    ...
    public CustomerController(SecurityUtils securityUtils, CustomerService customerService) {
    ...
    @GetMapping("/list")
    public ResultBean<List<Customer>> getBasicDetailList() {
    ...
    public ResultBean<PageInfo<Customer>> getBasicDetailList(@RequestParam("page") Integer page,
                                                                        @RequestParam("size") Integer size,
                                                                        @RequestParam("sort") String sort,
                                                                        @PathVariable("type") String type) {
        return customerService.queryInfo(page, size, sort);
    }
    ...
    public ResultBean<PageInfo<Customer>> getBasicDetailList(@RequestParam("page") Integer page,
        ...
        return customerService.selectRecordsByPage(page, size, sort, field, content);
    }
    ...
    @PostMapping("/add")
    public ResultBean<Integer> addBasicDetail(@RequestBody Customer basicDetail) {
        Date date = new Date();
        basicDetail.setCreateUser(securityUtils.getUserName());
        basicDetail.setCreateGmt(date);
        try {
            return customerService.createRecord(basicDetail);
    ...
    @PostMapping("/addList")
    public ResultBean<Integer> addBasicDetailList(@RequestBody List<Customer> deviceCategories) {
        ...
        return customerService.createRecords(deviceCategories);
    }
    ...
    public ResultBean<Integer> deleteBasicDetail(@PathVariable(value = "id") Long id) {
        return customerService.deleteRecord(id);
    }
    ...
    public ResultBean<Integer> deleteBasicDetailList(@RequestBody List<Object> ids) {
        return customerService.deleteRecords("id", ids);
    }
    ...
    @Parameters({
            ...
            @Parameter(name = "basicDetail", description = "设备类型维护信息实体", required = true)})
    @PutMapping("/{id}")
    public ResultBean<Integer> updateBasicDetail(@PathVariable(value = "id") Long id, @RequestBody Customer basicDetail) {
        Date date = new Date();
        basicDetail.setId(id);
        basicDetail.setModifiedUser(securityUtils.getUserName());
        basicDetail.setModifiedGmt(date);
        try {
            return customerService.updateNotNull(basicDetail);
        } catch (Exception e) {
