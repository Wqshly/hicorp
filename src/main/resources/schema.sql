...
CREATE TABLE IF NOT EXISTS `hicorp_segment`.`user` (
                                                       ...
                                                       `modified_gmt` DATETIME NULL DEFAULT NULL COMMENT 'Record modified time  (Use Greenwich Mean Time).',
                                                       PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `hicorp_segment`.`approve_process_sub`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hicorp_segment`.`approve_process_sub` ;

CREATE TABLE IF NOT EXISTS `hicorp_segment`.`approve_process_sub` (
                                                                      `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
                                                                      ...
                                                                      `pre_approver` VARCHAR(45) NULL DEFAULT NULL COMMENT '前一级的审批人',
                                                                      `post_approver` VARCHAR(45) NULL DEFAULT NULL COMMENT '后一级的审批人',
                                                                      `create_user` VARCHAR(45) NOT NULL,
                                                                      `create_gmt` DATETIME NOT NULL,
                                                                      `modified_user` VARCHAR(45) NULL DEFAULT NULL,
                                                                      `modified_gmt` DATETIME NULL DEFAULT NULL,
