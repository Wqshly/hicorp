...
CREATE TABLE IF NOT EXISTS `hicorp_segment`.`actual_orders` (
                                                                ...
                                                                `modified_gmt` DATETIME NULL DEFAULT NULL COMMENT '修改时间',
                                                                PRIMARY KEY (`id`),
                                                                INDEX `fk_actual_orders_original_orders1_idx` (`number` ASC) VISIBLE,
                                                                UNIQUE INDEX `number_UNIQUE` (`number` ASC) VISIBLE,
                                                                CONSTRAINT `fk_actual_orders_original_orders1`
                                                                    FOREIGN KEY (`number`)
                                                                        REFERENCES `hicorp_segment`.`original_orders` (`number`)
                                                                        ON DELETE NO ACTION
                                                                        ON UPDATE NO ACTION)
    ENGINE = InnoDB
    COMMENT = '实际销售订单表';
...
CREATE TABLE IF NOT EXISTS `hicorp_segment`.`actual_orders_sub` (
                                                                    `id` BIGINT UNSIGNED NOT NULL,
                                                                    `number` VARCHAR(45) NOT NULL COMMENT '订单编码',
                                                                    `name` VARCHAR(45) NOT NULL COMMENT '名称(需要生产的物料的名称)',
                                                                    `orders_number` VARCHAR(45) NOT NULL,
                                                                    `material_number` VARCHAR(45) NOT NULL COMMENT '管环物料编码(即自制件(成品)编码)',
                                                                    `model` VARCHAR(45) NOT NULL COMMENT '型号',
                                                                    `unit` VARCHAR(45) NOT NULL COMMENT '单位',
                                                                    `quantity` INT NOT NULL COMMENT '数量',
                                                                    `completed_quantity` VARCHAR(45) NOT NULL COMMENT '已完成(生产)的数量',
                                                                    `expected_delivery_date` DATETIME NOT NULL COMMENT '期望交货日期',
                                                                    `construction_section` VARCHAR(45) NOT NULL COMMENT '施工区间',
                                                                    `actual_delivery_date` DATETIME NULL COMMENT '实际交付日期',
                                                                    `remark` VARCHAR(255) NULL COMMENT '备注',
                                                                    `create_user` VARCHAR(45) NOT NULL COMMENT '创建人',
                                                                    `create_gmt` DATETIME NOT NULL COMMENT '创建时间',
                                                                    `modified_user` VARCHAR(45) NULL DEFAULT NULL COMMENT '修改人',
                                                                    `modified_gmt` DATETIME NULL DEFAULT NULL COMMENT '修改时间',
                                                                    PRIMARY KEY (`id`),
                                                                    INDEX `fk_actual_orders_sub_actual_orders1_idx` (`orders_number` ASC) VISIBLE,
                                                                    CONSTRAINT `fk_actual_orders_sub_actual_orders1`
                                                                        FOREIGN KEY (`orders_number`)
                                                                            REFERENCES `hicorp_segment`.`actual_orders` (`number`)
                                                                            ON DELETE NO ACTION
                                                                            ON UPDATE NO ACTION)
    ENGINE = InnoDB
    COMMENT = '实际销售订单子表';
...
CREATE TABLE IF NOT EXISTS `hicorp_segment`.`original_orders_sub` (
                                                                      ...
                                                                      `modified_gmt` DATETIME NULL DEFAULT NULL COMMENT '修改时间',
                                                                      PRIMARY KEY (`id`),
                                                                      INDEX `fk_original_orders_sub_original_orders1_idx` (`orders_number` ASC) VISIBLE,
                                                                      UNIQUE INDEX `number_UNIQUE` (`number` ASC) VISIBLE,
                                                                      CONSTRAINT `fk_original_orders_sub_original_orders1`
                                                                          FOREIGN KEY (`orders_number`)
                                                                              REFERENCES `hicorp_segment`.`original_orders` (`number`)
                                                                              ON DELETE NO ACTION
                                                                              ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `hicorp_segment`.`orders_change`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hicorp_segment`.`orders_change` ;

CREATE TABLE IF NOT EXISTS `hicorp_segment`.`orders_change` (
                                                                `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
                                                                `number` VARCHAR(45) NOT NULL COMMENT '变更单的编号(订单变更时,会产生一个变更订单, 这里的变更单特指变更订单.)',
                                                                `orders_number` VARCHAR(45) NOT NULL COMMENT '变更单对应的原始订单编号',
                                                                `change_customer_person` VARCHAR(45) NOT NULL COMMENT '提出变更需求的客户名',
                                                                `change_customer_time` DATETIME NOT NULL,
                                                                `auditor` VARCHAR(45) NULL COMMENT '审核人',
                                                                ...
                                                                `modified_gmt` DATETIME NULL DEFAULT NULL COMMENT '修改时间',
                                                                PRIMARY KEY (`id`),
                                                                INDEX `fk_orders_change_original_orders1_idx` (`orders_number` ASC) VISIBLE,
                                                                UNIQUE INDEX `number_UNIQUE` (`number` ASC) VISIBLE,
                                                                CONSTRAINT `fk_orders_change_original_orders1`
                                                                    FOREIGN KEY (`orders_number`)
                                                                        REFERENCES `hicorp_segment`.`original_orders` (`number`)
                                                                        ON DELETE NO ACTION
                                                                        ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `hicorp_segment`.`orders_sub_change`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `hicorp_segment`.`orders_sub_change` ;

CREATE TABLE IF NOT EXISTS `hicorp_segment`.`orders_sub_change` (
                                                                    `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
                                                                    `number` VARCHAR(45) NOT NULL COMMENT '每一条详情数据的编号',
                                                                    `orders_change_number` VARCHAR(45) NOT NULL COMMENT '订单变更表的编号',
                                                                    `original_orders_sub_number` VARCHAR(45) NOT NULL COMMENT '原始订单详情数据的编号',
                                                                    `name` VARCHAR(45) NOT NULL COMMENT '物料(成品)名称',
                                                                    `material_number` VARCHAR(45) NOT NULL COMMENT '管环物料编码(自制件, 即成品)',
                                                                    ...
                                                                    `modified_gmt` DATETIME NULL DEFAULT NULL COMMENT '修改时间',
                                                                    PRIMARY KEY (`id`),
                                                                    INDEX `fk_orders_sub_change_orders_change1_idx` (`orders_change_number` ASC) VISIBLE,
                                                                    INDEX `fk_orders_sub_change_original_orders_sub1_idx` (`original_orders_sub_number` ASC) VISIBLE,
                                                                    CONSTRAINT `fk_orders_sub_change_orders_change1`
                                                                        FOREIGN KEY (`orders_change_number`)
                                                                            REFERENCES `hicorp_segment`.`orders_change` (`number`)
                                                                            ON DELETE NO ACTION
                                                                            ON UPDATE NO ACTION,
                                                                    CONSTRAINT `fk_orders_sub_change_original_orders_sub1`
                                                                        FOREIGN KEY (`original_orders_sub_number`)
                                                                            REFERENCES `hicorp_segment`.`original_orders_sub` (`number`)
                                                                            ON DELETE NO ACTION
                                                                            ON UPDATE NO ACTION)
    ENGINE = InnoDB
    COMMENT = '订单变更详情表';
